...
Clone repository
```
git clone https://github.com/angel-christian25/QuickHire.git
```
...
To have a local copy of thist up and running on your local machine, you will first need to install the following software:
